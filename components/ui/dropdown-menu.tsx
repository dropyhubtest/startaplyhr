...
function DropdownMenuTrigger({ ...props }: MenuPrimitive.Trigger.Props) {
  return <MenuPrimitive.Trigger suppressHydrationWarning data-slot="dropdown-menu-trigger" {...props} />
}
